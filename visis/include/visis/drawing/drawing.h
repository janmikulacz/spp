...
#ifndef VISIS_DRAWING_DRAWING_H_
#define VISIS_DRAWING_DRAWING_H_

#include "visis/drawing/cairo_geom_drawer.h"
...
inline MapDrawer MakeMapDrawer(
    const trivis::geom::FLimits &lim = trivis::geom::FLimits{},
    double res = kDefaultMakeMapDrawerRes,
    double relative_frame_width = KDefaultMakeMapDrawerRelativeFrameWidth
) {
...
#endif //VISIS_DRAWING_DRAWING_H_
