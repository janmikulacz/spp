...
#ifndef VISIS_DRAWING_CAIRO_GEOM_DRAWER_H_
#define VISIS_DRAWING_CAIRO_GEOM_DRAWER_H_
...
public:
    ...
    void DrawPolygon(
        ...
        DrawPolygon(poly, true, fill_color, false, 0.0, kColorBlack, opacity);
    }
    ...
    void DrawPolygons(
        ...
        DrawPolygons(poly, true, fill_color, false, 0.0, kColorBlack, opacity);
    }
...
#endif //VISIS_DRAWING_CAIRO_GEOM_DRAWER_H_
