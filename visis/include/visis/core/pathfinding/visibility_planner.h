...
#ifndef VISIS_CORE_PATHFINDING_VISIBILITY_PLANNER_H_
#define VISIS_CORE_PATHFINDING_VISIBILITY_PLANNER_H_
...
#endif //VISIS_CORE_PATHFINDING_VISIBILITY_PLANNER_H_
