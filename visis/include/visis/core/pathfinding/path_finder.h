...
#ifndef VISIS_CORE_PATHFINDING_PATH_FINDER_H_
#define VISIS_CORE_PATHFINDING_PATH_FINDER_H_

#include "visis/core/pathfinding/visibility_planner.h"
...
public:
    ...
    std::optional<data::PTreeGeom> ConstructReflexVisibilityGraph(const trivis::Trivis &vis);

    std::optional<data::PTreeGeom> PrecomputeReflexShortestPaths();

    std::optional<data::PTreeGeom> ConstructCitiesVisibilityGraph(
        const trivis::Trivis &vis,
        trivis::geom::FPoints cities
    );

    std::optional<data::PTreeGeom> PrecomputeCitiesShortestPaths();
...
private:
    ...
    core::pathfinding::BoostGraph _reflex_graph;
    // The visibility planner.
    core::pathfinding::VisibilityPlanner _vis_planner;
...
#endif //VISIS_CORE_PATHFINDING_PATH_FINDER_H_
