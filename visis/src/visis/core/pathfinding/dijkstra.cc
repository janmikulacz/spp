...
void pathfinding::ComputeShortestPathsDijkstraAllPairsReflex(
...
std::vector<int> pathfinding::GetShortestIDPathAllPairsReflex(
    int source_id,
    int target_id,
...
double pathfinding::ComputeShortestPathDijkstraCities(
...
trivis::geom::FPoints pathfinding::ConvertIDPathToPointPathCities(
    const std::vector<int> &id_path_no_endpoints,
    const trivis::geom::FPoints &reflex_vertices_points,
    const trivis::geom::FPoint &source_city,
    const trivis::geom::FPoint &target_city
) {
    auto point_path = utils::Concatenate({source_city}, utils::Select(reflex_vertices_points, id_path_no_endpoints));
    point_path.push_back(target_city);
    return point_path;
}

void pathfinding::ComputeShortestPathsDijkstraAllPairsCities(
...
double pathfinding::GetShortestPathLengthAllPairsCities(
    int source_city_id,
    int target_city_id,
...
std::vector<int> pathfinding::GetShortestIDPathAllPairsCities(
    int source_city_id,
    int target_city_id,
    int n_reflex_vertices,
...
geom::FPoints pathfinding::ConvertIDPathToPointPathAllPairsCities(
