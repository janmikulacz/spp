...
void VisibilityPlanner::Init(
    ...
    const geom::FPoints &reflex_points,
    ...
    _graph_points = geom::FPoints(reflex_points);
...
double VisibilityPlanner::FindShortestPath(
    const geom::FPoint &source_city,
    const geom::FPoint &target_city,
    const Trivis &vis,
...
void VisibilityPlanner::FindShortestPaths(
    const geom::FPoint &source_city,
    const geom::FPoints &target_cities,
    const Trivis &vis,
